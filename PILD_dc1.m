...
load D:\highimbalance\IDA2016Challenge\trainnb.txt;
load D:\highimbalance\IDA2016Challenge\ntr.txt;
dim=size(trainnb,2)-2;
%dim=8;
sign0=[];
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\basicdata_trainnb.txt','w');
...
for r=1:c-1,
    for t=r+1:c,
        ...
        d=d0;
        a0=[];
        a0(:,2:dim+1)=trainnb(ntr(r,1):ntr(r,2),1:dim);
        ...
        a0(p0+1:p0+q0,2:dim+1)=trainnb(ntr(t,1):ntr(t,2),1:dim);        
        if q0==1
...
%%/////////////////////////////////////////////////////////////////////////////////////////////
         ...
         fprintf(fid,'runtime(%d,%d)=%g\n',r,t,t1);
%///////////////////////////////////////////////////////////////////////////////////
         if (aver_index(3)>0.025)&(((ir>99)&(numtr_0(3)<=numtr_0(2))&(numtr_0(2)<=numtr_0(1)))|(ir<=99))
...
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\w0.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w2');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta0.txt','w');
    fprintf(fid,'%.8f\n',theta2');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\w.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w4');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta.txt','w');
    fprintf(fid,'%.8f\n',theta4');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\w1.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w6');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta1.txt','w');
    fprintf(fid,'%.8f\n',theta6');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\w2.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w8');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta2.txt','w');
    fprintf(fid,'%.8f\n',theta8');
fclose(fid);
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\sign0.txt','w');
    fprintf(fid,'%g\n',sign0');
fclose(fid);
...
load D:\highimbalance\IDA2016Challenge\trainnb.txt;
load D:\highimbalance\IDA2016Challenge\ntr.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w0.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w1.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w2.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta0.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta1.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\theta2.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\sign0.txt;
...
for r=1:c-1,
    for t=r+1:c,
        ...
        p0=ntr(r,3);
        q0=ntr(t,3);
        a=trainnb(ntr(r,1):ntr(r,2),1:dim);
        a(p0+1:p0+q0,:)=trainnb(ntr(t,1):ntr(t,2),1:dim);
...
% AUC
        ...
        area_trainnb(r,t)=0;
        for i=2:p0+q0+1,
            area_trainnb(r,t)=area_trainnb(r,t)+b(i,2)*(b(i,1)-b(i-1,1));
        end
        area_trainnb(r,t);
...
%        fprintf(fid,'(r,t)=%d\n',r,t);
        ...
        err_trainnb(r,t-1)=100*(1-(numtr0(1)+numtr0(2))/(p0+q0));
        err_trainnb(r,c+t-2)=100*((p0-numtr0(1))/p0+(q0-numtr0(2))/q0)/2;
        err_trainnb(r,2*c+t-3)=100*sqrt(((p0-numtr0(1))/p0)*((q0-numtr0(2))/q0));
        err_trainnb(r,3*c+t-4)=100*area_trainnb(r,t);
        err_trainnb(r,4*c+t-5)=(err_trainnb(r,t-1)+err_trainnb(r,c+t-2)+err_trainnb(r,2*c+t-3)+area_trainnb(r,t)*100)/4;
    end
end

err_trainnb
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\err_trainnb.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the testnb set.
load D:\highimbalance\IDA2016Challenge\testnb.txt;
load D:\highimbalance\IDA2016Challenge\nte.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w0.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w.txt;
load D:\highimbalance\IDA2016Challenge\inv_dc1\result\w1.txt;
...
for r=1:c-1,
    for t=r+1:c,
        ...
        p0=nte(r,3);
        q0=nte(t,3);
        a=testnb(nte(r,1):nte(r,2),1:dim);
        a(p0+1:p0+q0,:)=testnb(nte(t,1):nte(t,2),1:dim);
        re0=a*(w0(k,:))'+ones(p0+q0,1)*theta0(k);
        kk=sum(sign0(1:k));
        if sign0(k)==7
           re=a*(w(kk-6:kk,:))'+ones(p0+q0,1)*theta(kk-6:kk)';
...
% AUC
        ...
        area_testnb(r,t)=0;
        for i=2:p0+q0+1,
            area_testnb(r,t)=area_testnb(r,t)+b(i,2)*(b(i,1)-b(i-1,1));
        end
        area_testnb(r,t);
...
%        fprintf(fid,'(r,t)=%d\n',r,t);
        ...
        err_testnb(r,t-1)=100*(1-(numtr0(1)+numtr0(2))/(p0+q0));
        err_testnb(r,c+t-2)=100*((p0-numtr0(1))/p0+(q0-numtr0(2))/q0)/2;
        err_testnb(r,2*c+t-3)=100*sqrt(((p0-numtr0(1))/p0)*((q0-numtr0(2))/q0));
        err_testnb(r,3*c+t-4)=100*area_testnb(r,t);
        err_testnb(r,4*c+t-5)=(err_testnb(r,t-1)+err_testnb(r,c+t-2)+err_testnb(r,2*c+t-3)+area_testnb(r,t)*100)/4;
    end
end

err_testnb
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\err_testnb.txt','w');
    fprintf(fid,'%g %g %g %g %g\n',err_testnb');
fclose(fid);
...
% Majority vote for the trainnbing set
...
for i=1:n0,
    re0=trainnb(i,1:dim)*w0'+theta0';
    re1=trainnb(i,1:dim)*w'+theta';
    re2=trainnb(i,1:dim)*w1'+theta1';
    re3=trainnb(i,1:dim)*w2'+theta2';
    n00=0;
    for j=1:c-1,
        for k=j+1:c,
            n00=n00+1;
...
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\Number_error_trainnb.txt','w');
    fprintf(fid,'\nFor the trainnb set\n');
    fprintf(fid,'\n%g %g\n',nerr');
    fprintf(fid,'\n%g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
%clear all;
%t0=clock;
% Majority vote for the testnb set
...
for i=1:n0,
    re0=testnb(i,1:dim)*w0'+theta0';
    re1=testnb(i,1:dim)*w'+theta';
    re2=testnb(i,1:dim)*w1'+theta1';
    re3=testnb(i,1:dim)*w2'+theta2';
    n00=0;
    for j=1:c-1,
        for k=j+1:c,
            n00=n00+1;
...
fid=fopen('D:\highimbalance\IDA2016Challenge\inv_dc1\result\Number_error_testnb.txt','w');
    fprintf(fid,'\nFor the testnb set\n');
    fprintf(fid,'\n%g %g\n',nerr');
    fprintf(fid,'\n%g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
